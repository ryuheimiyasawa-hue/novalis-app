...
export function RestaurantsFilter({ currentPrefecture, currentIsActive }: Props) {
  ...
  function navigate(next: { prefecture_code?: string | null; is_active?: string | null }) {
    ...
    router.push(`/admin/restaurants${url.size ? `?${url.toString()}` : ""}`);
  }
      ...
      <div className="space-y-1">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="true">掲載中</SelectItem>
            <SelectItem value="false">非掲載</SelectItem>
          </SelectContent>
        </Select>
      </div>
      <div className="space-y-1">
