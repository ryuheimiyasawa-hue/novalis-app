...
> **現在進行中(2026-09-13)**: 弁護士監修対応。同意フロー 1.1 実装済み（PR #29 マージ待ち、migration 012 は 2026-09-13 本番適用済み）。
> 再開は `docs/lawyer-review-actions.md` の「次回再開時にやること」から。migration は適用済みなので PR マージで反映できる。
