...
> **現在進行中(2026-09-13)**: 弁護士監修対応。同意フロー 1.1 実装済み（ブランチ `legal/lawyer-review-1.1`、migration 012 本番未適用）。
> 再開は `docs/lawyer-review-actions.md` の「次回再開時にやること」から。**本番反映は migration → デプロイの順**。
